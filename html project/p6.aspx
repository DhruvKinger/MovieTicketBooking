<%@ Page Language="C#" AutoEventWireup="true" CodeFile="p6.aspx.cs" Inherits="Default6" %>

<!DOCTYPE>
<html>
<head>
	<link rel="stylesheet" type="text/css" href="style1.css">
	<title>NIKKA ZAILDAR 2</title>
</head>
<body>
    <form id="form1" runat="server">
 	<h1><b>NIKKA ZAILDAR 2</b></h1>
	<img src="download.jpg" alt="LAAUNGI LAACHI" width="1366px" height="700px" class="A">
		<p>A man becomes involved in a love triangle when he is forced to marry against his wishes.
</p>
...
<p>
	<b>No doubt Bai Simarjit is a competent director. Movie based on a crisp screenplay. Smooth flow of comic situations ...
</b>
</p>
<p>
	<b>Some of the dialogue are very embarrassing if you are watching with family. I feel punjabi movies are becoming ...

</b>
	<br/>
<b><br>part one was superbb but dis one is bullshit!! its really full of cheapo dialectzz !!not a family movie i would say its simply ...
</b>
</p>
